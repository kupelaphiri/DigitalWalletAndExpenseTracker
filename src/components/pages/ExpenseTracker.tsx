    ...
    <div className="p-6 max-w-6xl mx-auto">
      ...
      <div className="flex flex-col lg:flex-row gap-4 mb-8">
        <div className="bg-white rounded-xl shadow-md p-6 flex-1">
          ...
          <p className="text-4xl font-bold text-gray-800 mb-2">${totalExpenses.toFixed(2)}</p>
                ...
                amount > 0 && (
                  <div key={category} className="relative">
                    <div className="flex justify-between items-center mb-1">
                      ...
                      <span className="text-sm text-gray-900">${amount.toFixed(2)} <span className="text-gray-500 text-xs">({((amount / totalExpenses) * 100).toFixed(1)}%)</span></span>
                    </div>
              ...
              return (
                <div key={month.month} className="flex flex-col items-center flex-1">
                  ...
                  <div className="mt-2 text-center">
                    ...
                    <div className="text-sm text-gray-500">${month.amount.toFixed(0)}</div>
                  </div>
                </div>
              );
            })}
            ...
            <div className="flex justify-between items-center">
              <div>
                ...
                <span className="ml-2 text-gray-900 font-medium">
                  ${(monthlyExpenses.reduce((sum, month) => sum + month.amount, 0) / monthlyExpenses.length).toFixed(2)}
                </span>
              </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b">
                ...
                <th className="py-3 px-4 text-left text-gray-500 font-medium text-sm">Description</th>
                <th className="py-3 px-4 text-right text-gray-500 font-medium text-sm">Amount</th>
              </tr>
            </thead>
            <tbody>
              <tr className="border-b hover:bg-gray-50">
                <td className="py-3 px-4 text-sm text-gray-800">Apr 17, 2025</td>
                <td className="py-3 px-4">
                  <span className="px-2 py-1 bg-blue-100 text-blue-700 rounded-md text-xs">Food</span>
                </td>
                <td className="py-3 px-4 text-sm text-gray-600">Grocery Shopping</td>
                <td className="py-3 px-4 text-right text-sm font-medium text-red-600">-$85.20</td>
              </tr>
              <tr className="border-b hover:bg-gray-50">
                <td className="py-3 px-4 text-sm text-gray-800">Apr 15, 2025</td>
                <td className="py-3 px-4">
                  <span className="px-2 py-1 bg-purple-100 text-purple-700 rounded-md text-xs">Entertainment</span>
                </td>
                <td className="py-3 px-4 text-sm text-gray-600">Movie tickets</td>
                <td className="py-3 px-4 text-right text-sm font-medium text-red-600">-$35.99</td>
              </tr>
              <tr className="border-b hover:bg-gray-50">
                <td className="py-3 px-4 text-sm text-gray-800">Apr 12, 2025</td>
                <td className="py-3 px-4">
                  <span className="px-2 py-1 bg-yellow-100 text-yellow-700 rounded-md text-xs">Utilities</span>
                </td>
                <td className="py-3 px-4 text-sm text-gray-600">Electricity bill</td>
                <td className="py-3 px-4 text-right text-sm font-medium text-red-600">-$120.50</td>
              </tr>
              <tr className="border-b hover:bg-gray-50">
                <td className="py-3 px-4 text-sm text-gray-800">Apr 10, 2025</td>
                <td className="py-3 px-4">
                  <span className="px-2 py-1 bg-green-100 text-green-700 rounded-md text-xs">Income</span>
                </td>
                <td className="py-3 px-4 text-sm text-gray-600">Salary deposit</td>
                <td className="py-3 px-4 text-right text-sm font-medium text-green-600">+$2,500.00</td>
              </tr>
              <tr className="hover:bg-gray-50">
                <td className="py-3 px-4 text-sm text-gray-800">Apr 5, 2025</td>
                <td className="py-3 px-4">
                  <span className="px-2 py-1 bg-orange-100 text-orange-700 rounded-md text-xs">Transport</span>
                </td>
                <td className="py-3 px-4 text-sm text-gray-600">Fuel</td>
                <td className="py-3 px-4 text-right text-sm font-medium text-red-600">-$45.75</td>
              </tr>
            </tbody>
          </table>
        </div>
